...
export const Route = createFileRoute("/")({
  head: () => ({ meta: [
    ...
    { name: "description", content: "اكتشف العقارات المميزة والمجمعات السكنية والوكالات العقارية وأدوات البائعين في مصر. منصة عقارية فاخرة للأفراد والوسطاء والمطورين." },
    { name: "keywords", content: "عقارات مصر, شقق للبيع, فلل للبيع, عقارات فاخرة, وسيط عقاري, مجمعات سكنية, أصولك" },
    { name: "robots", content: "index, follow" },
    { property: "og:type", content: "website" },
    { property: "og:site_name", content: "أصولك" },
    { property: "og:title", content: "أصولك — وساطة عقارية فاخرة في مصر" },
    { property: "og:description", content: "اكتشف العقارات المميزة والمجمعات السكنية والوكالات في مصر. منصة عقارية فاخرة." },
    { property: "og:image", content: "/properties/ahel-masr-walkway/01.webp" },
    { property: "og:image:width", content: "1200" },
    { property: "og:image:height", content: "630" },
    { property: "og:image:alt", content: "أصولك — العقارات الفاخرة في مصر" },
    { property: "og:locale", content: "ar_EG" },
    { name: "twitter:card", content: "summary_large_image" },
    { name: "twitter:site", content: "@osoulk" },
    { name: "twitter:title", content: "أصولك — وساطة عقارية فاخرة في مصر" },
    { name: "twitter:description", content: "اكتشف العقارات المميزة والمجمعات السكنية في مصر." },
    { name: "twitter:image", content: "/properties/ahel-masr-walkway/01.webp" },
    { name: "twitter:image:alt", content: "أصولك — العقارات الفاخرة في مصر" },
  ],
  links: [
    { rel: "canonical", href: "https://osoulk.com/" },
  ],
  scripts: [{
    ...
    children: JSON.stringify({
      ...
      "logo": "https://osoulk.com/og-logo.png",
      "description": "منصة وساطة عقارية فاخرة في مصر للأفراد والوسطاء والمطورين",
      "address": { "@type": "PostalAddress", "addressCountry": "EG", "addressLocality": "Cairo" },
      "telephone": "+201025812666",
      "sameAs": ["https://www.facebook.com/osoulk", "https://www.instagram.com/osoulk"],
