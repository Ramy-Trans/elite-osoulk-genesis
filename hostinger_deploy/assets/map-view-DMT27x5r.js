const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/leaflet-src-yY-K2mVj.js","assets/index-ByTMZSof.js","assets/index-WcFVdlfK.css","assets/leaflet-CIGW-MKW.css"])))=>i.map(i=>d[i]);
import{r as s,_ as f,j as w}from"./index-ByTMZSof.js";function $({markers:c,onSelect:p,selectedId:d,center:h,zoom:g=11}){const l=s.useRef(null),r=s.useRef(null),i=s.useRef([]),m=h||[30.0444,31.2357];return s.useEffect(()=>{if(!(!l.current||r.current))return f(()=>import("./leaflet-src-yY-K2mVj.js").then(o=>o.l),__vite__mapDeps([0,1,2])).then(o=>{if(f(()=>Promise.resolve({}),__vite__mapDeps([3])),delete o.Icon.Default.prototype._getIconUrl,o.Icon.Default.mergeOptions({iconRetinaUrl:"https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.9.4/images/marker-icon-2x.png",iconUrl:"https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.9.4/images/marker-icon.png",shadowUrl:"https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.9.4/images/marker-shadow.png"}),!l.current)return;const t=o.map(l.current,{center:m,zoom:g,zoomControl:!0});if(o.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:'&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a>',maxZoom:19}).addTo(t),r.current=t,(a=>{i.current.forEach(e=>e.remove()),i.current=[],a.forEach(e=>{const n=e.id===d,v=o.divIcon({className:"",html:`<div style="
          ...
          `),x=o.marker([e.lat,e.lng],{icon:v}).addTo(t).bindPopup(b);x.on("click",()=>{p&&p(e.id)}),i.current.push(x)})})(c),c.length>1){const a=o.featureGroup(i.current);t.fitBounds(a.getBounds().pad(.1))}}),()=>{r.current&&(r.current.remove(),r.current=null)}},[]),s.useEffect(()=>{r.current&&f(()=>import("./leaflet-src-yY-K2mVj.js").then(o=>o.l),__vite__mapDeps([0,1,2])).then(o=>{i.current.forEach(t=>t.remove()),i.current=[],c.forEach(t=>{const u=t.id===d,a=o.divIcon({className:"",html:`<div style="
